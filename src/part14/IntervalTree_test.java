...
/**
 * 区间树的java实现 
 * An interval tree is an ordered tree data structure to hold
 * intervals. Specifically, it allows one to efficiently find all intervals that
 ...
 */
public class IntervalTree_test<O extends Object> {
	 ...
	 */
	public IntervalTree_test(List<IntervalData<O>> intervals) {
		if (intervals.size() <= 0)
			return;
	...
	protected static class IntervalTreePrinter {
		...
		public static <O extends Object> String getString(IntervalTree_test<O> tree) {
			if (tree.root == null)
